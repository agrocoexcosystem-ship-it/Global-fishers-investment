      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Risk Disclosure</h1>
          ...
          <div className="mt-12 text-center text-sm text-slate-500">
            <p>For risk-related inquiries: <span className="text-emerald-400">compliance@global-fishers.com</span></p>
          </div>
        </div>
      </section>
    </div>
