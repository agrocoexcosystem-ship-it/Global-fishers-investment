        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Compliance & <span className="italic text-emerald-400">Regulations</span>
            </h1>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Global Fishers Investment is committed to maintaining the highest standards of regulatory compliance across all jurisdictions we operate in.
            </p>
          </div>
          ...
          >
            <div className="p-10 rounded-2xl bg-slate-800/50 border border-slate-700">
              ...
              <p className="text-slate-300 leading-relaxed text-lg mb-4">
                Global Fishers Investment operates under a comprehensive regulatory framework designed to protect 
                our investors and ensure the integrity of all financial operations. We adhere to international 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              >
                <item.icon size={28} className="text-emerald-400 mb-4" />
          ...
          <div className="p-10 rounded-2xl bg-slate-800/50 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="text-center p-6 rounded-xl bg-slate-700/30">
                  <div className="text-2xl font-bold text-emerald-400 mb-2">{cert.title}</div>
